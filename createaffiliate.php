...
<div class="page-content">
   ...
   <div class="portlet box green">
                           <div class="portlet-title">
                              <div class="caption"><i class="icon-reorder"></i>Create Affiliate</div>
                              <div class="tools">
 ...
 <h3 class="form-section">Add User</h3>        
                                     ...
                                     <div class="form-group">
                                       ...
                                       <div class="col-md-4">
                                          <input type="password" class="form-control" placeholder="Enter text">
                                          <span class="help-block">A block of help text.</span>
                                       </div>
                                    </div>
...
<h3 class="form-section">Settings</h3>
                                          ...
                                          <div class="form-group">
                                             <label class="col-md-3 control-label">Account Manager</label>
                                             <div class="col-md-4">
                                             <select class="form-control">
                                                <option value="">Male</option>
                                                <option value="">Female</option>
