         ...
         <ul class="page-sidebar-menu">
            ...
            <li class="">
               ...
               <ul class="sub-menu">
                  ...
                  <li >
                     <a href="offerapplication">
                     Offer Applcations</a>
                  </li>
                  <li >
                     <a href="offercategories">
                     Offer Categories</a>
                  </li>
                  <li >
                     <a href="offergroups">
            ...
            <li class="">
               ...
               <ul class="sub-menu">
                  ...
                  <li >
                     <a href="affiliatereport">
                     Affiliates Report</a>
                  </li>
                  <li >
                     <a href="advertiserreport">
                     Advertisers Report</a>
                  </li>
                  <li >
                     <a href="offerreport">
                     Offers Report</a>
                  ...
                  <li >
                     <a href="adcampaignReport">
                     Ad Campaigns Report</a>
                  </li>
                  <li >
                     <a href="coversionreport">
                     Conversion Report</a>
                  </li>
                  <li >
                     <a href="conversionstatus">
                     Conversion Status</a>
                  </li>
                  <li >
                     <a href="trafficrefferal">
                     Traffic Referrals</a>
                  </li>
                  <li >
                     <a href="managecommission">
                     Manager Commission</a>
                  </li>
                  <li >
                     <a href="serverlogs">
                     Server Logs</a>
            ...
            <li class="">
               ...
               <ul class="sub-menu">
                  <li >
                     <a href="manageaffiliate">
                     Manage Affiliates</a>
                  </li>
                  <li >
                     <a href="pendingaffiliate">
                     Pending Affiliates</a>
                  </li>
                  <li >
                     <a href="index.php/createaffiliate">
                     Create Affiliates</a>
                  </li>
                  <li >
                     <a href="conversionpixel">
                     Conversion Pixels/URLs</a>
                  </li>
                  <li >
                     <a href="adjuststats">
                     Adjust Stats</a>
            ...
            <li class="">
               ...
               <ul class="sub-menu">
                  <li >
                     <a href="manageadvertiser">
                     Manage Advertisers</a>
                  </li>
                  <li >
                     <a href="pendingadverstiser">
                     Pending Advertisers</a>
                  </li>
                  <li >
                     <a href="index.php/createadvertiser">
                     Create Advertisers</a>
                  </li>
                  <li >
                     <a href="manageuser">
                    Manage Users</a>
                  ...
                  <li >
                     <a href="advertiserbilling">
                     Advertiser Billing</a>
                  </li>
               </ul>
            </li>
            <li class="">
               <a href="javascript:;">
               <span class="title">Ad Manager</span>
               <span class="arrow "></span>
               </a>
               <ul class="sub-menu">
                  <li >
                     <a href="managecampaign">
                     Manage Campaigns</a>
                  </li>
                  <li >
